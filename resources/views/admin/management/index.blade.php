            ...
            <div class="row mb-2">
                ...
                <div class="col-12 col-sm-6" >
                    <div class="float-sm-right">
                        <form action="{{route('management.create')}}">
                            ...
                            <div class="form-group">
                                <div class="input-group ">
                                    ...
                                    <div class="input-group-append" style="margin-left: 10px;}">
                                        ...
                                        <a href="{{route('management.index')}}" class="btn  btn-default"  style="margin-left: 10px;"><i class="far fa-undo"></i></a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('management.edit',$item->id)}}" title="Chỉnh sửa" class="btn btn-xs btn-info btn-edit">
                                                        <i class="fas fa-edit"></i></i>
                                                    </a>
                                                    <a href="javascript:void(0);" class="btn btn-xs btn-danger btn-destroy" 
                                                         title="Xóa" data-href="{{route('management.get.delete',$item->id)}}">
